...
//  { "EMG",                    "uV",    "%.1fuV",          "%.1f", (float)0.10  },
    ...
    { "Marker Acceleration",    "m/ss",  "%.3fm/ss",        "%.3f", (float)0.05  },
    ...
    { "VectAnglular Acc.",      "rad/ss","%.3f radians/ss", "%.3f", (float)0.001 },
    ...
    { "Joint Centre Acc.",      "m/ss",  "%.3fm/ss",        "%.3f", (float)0.05  },
    ...
    { "Segment Angular Acc.",   "rad/ss","%.3f radians/ss", "%.3f", (float)0.001 },
    ...
    { "Virtual Marker Acc.",    "m/ss",  "%.3fm/ss",        "%.3f", (float)0.05  },
    ...
    { "Marker |Acc|",           "m/ss",  "%.3fm/ss",        "%.3f", (float)0.005 },
